...
export const renderComments = ({ comments, handleCommentAnswerClick, handleCommentLikeClick }) => {
    ...
    const showInputButtonComment = `
      <div class="add-form" id="form-comment">
        ...
        placeholder="Введите ваш комментарий" rows="4"
    ...
    `
    const textEnter = `<div id="toggle-page">Чтобы добавить комментарий, авторизуйтесь</div>
    </div>`
    const addComments = () => {
        ...
        buttonElement.addEventListener("click", () => {
            ...
            sendAndRenderComments(textElement.value)
                .then(() => {
                    initApp();
                })
                .then(() => {
